...
export const explanations = {
  ...
  109: {
    summary:
      "A washed-up anti-smoking activist tries to recruit the boys for his campaign, which turns out to be more about his own ego and grudge against tobacco companies than public health. It's a direct parody of real celebrity-fronted anti-smoking ad campaigns of the early 2000s.",
  },
  // The Passion of the Jew (S8E3)
  114: {
    summary:
      "Cartman becomes obsessed with a gruesome new religious film and starts a Mel Gibson fan club. This is a direct response to Mel Gibson's 2004 film The Passion of the Christ, both its extreme violence and the controversy over whether it played into antisemitic stereotypes.",
  },
  // Goobacks (S8E7)
  118: {
    summary:
      "People from thousands of years in the future start time-traveling to the present to take low-wage jobs, and South Park's residents panic about immigrants 'coming down here' and taking work. It's a fairly unsubtle stand-in for real debates over immigration and low-wage labor, mocking xenophobic rhetoric on all sides.",
  },
  // Douche and Turd (S8E8)
  119: {
    summary:
      "The school mascot election comes down to a literal giant douche versus a turd sandwich, and Stan refuses to vote for either. It's a direct commentary on the 2004 Bush-vs-Kerry presidential election and the feeling that both major-party choices were equally unappealing.",
  },
  // Something Wall-Mart This Way Comes (S8E9)
  120: {
    summary:
      "A giant discount superstore moves in and slowly destroys every small business in town, even as the townspeople keep shopping there anyway. It's a direct parable about Walmart's real-world reputation for undercutting and closing local Main Street businesses.",
  },
  // Stupid Spoiled Whore Video Playset (S8E12)
  123: {
    summary:
      "Girls in South Park become obsessed with a vapid, famous-for-being-famous heiress and get a toy playset that rewards acting just like her. It's a direct parody of Paris Hilton and the mid-2000s tabloid/reality-TV machine that made fame itself the product.",
  },
  // Mr. Garrison's Fancy New Vagina (S9E1)
  126: {
    summary:
      "Mr. Garrison gets sex-reassignment surgery, while Kyle's dad wants to have his human arm replaced with one from a mouse. The episode braids together two real hot-button topics of the time: transgender identity and sex-change surgery, and the stem-cell research debate epitomized by Christopher Reeve's advocacy.",
  },
  // Best Friends Forever (S9E4)
  129: {
    summary:
      "Kenny is left brain-dead, and his family fights in court over whether to remove his feeding tube while protesters gather outside the hospital. This is a direct, fast-turnaround response to the Terri Schiavo case, the 2005 right-to-die legal battle that dominated American news for weeks.",
  },
